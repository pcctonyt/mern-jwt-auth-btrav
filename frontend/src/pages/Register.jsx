...
function Register() {
  ...
  //we select what we need from the state object using useSelector
  ...
  const onSubmit = (e) => {
    ...
    if(password !== password2) {
        ...
        //because the register function takes in an object of user's data
        const userData = {
            name, 
            email, 
            password,
    ...
    <>
        ...
        <section className="form">
            <form onSubmit={onSubmit}>
                ...
                <div className="form-group">
                    <input type="password" className="form-control" id="password2" name="password2" value={password2} placeholder="Confirm your new password" onChange={onChange} />
                </div>
                <div className="form-group">
